...
# https://github.com/mesolitica/vllm-whisper/blob/main/vllm/model_executor/models/whisper.py
# Original repository by: Mesolitica
# License: [Apache License 2.0](https://github.com/mesolitica/vllm-whisper/blob/main/LICENSE)
#
# Note: Modifications may have been made to integrate it with our codebase.
# ----------------------------------------------------------------------
